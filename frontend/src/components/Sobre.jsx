...
const Sobre = () => {
  return (
    <div className="container my-32 mx-auto border-b-2 border-divider-3 dark:border-divider-2 pb-4 flex gap-12 flex-col md:flex-row justify-between px-5"> 
    <div className='max-w-4xl'>
      <h2 className='text-2xl font-bold mb-2 text-center md:text-left'>Redes sociais</h2>
