  ...
  return (
    ...
    <nav
      className={`${styles.paddingX
        } w-full flex items-center py-1 fixed top-0 z-20 ${scrolled ? "gradientecor" : "gradientecor"
        }`}
    >
      ...
      <div className='w-full flex justify-between items-center max-w-7xl mx-auto'>
        ...
        <div className="max-[768px]:hidden flex estilo items-center " >
          <Link to="/login">
            <div className="flex items-center">
              <img src={imagen8} width={20} className="m-2 hover:scale-110" />
